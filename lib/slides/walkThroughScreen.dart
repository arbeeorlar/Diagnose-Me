...
import 'package:self_diagnose/components/backgroundView.dart';
  ...
  Widget firstScreen(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            backgroundView(backgroundImages: "Assets/images/slide1.jpeg"),
            Container(
  ...
  Widget secondScreen(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            backgroundView(backgroundImages: "Assets/images/slide2.jpeg"),
            Container(
              width: MediaQuery.of(context).size.width,
              height: MediaQuery.of(context).size.height,
              color: Colors.transparent.withOpacity(0.78),
            ),
            Container(
                margin: EdgeInsets.only(top: (screenSizeHeight * 0.60)),
                // margin: EdgeInsets.only(left:50),
  ...
  Widget thirdScreen(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            backgroundView(backgroundImages: "Assets/images/slide3.jpeg"),
            Container(
              width: MediaQuery.of(context).size.width,
              height: MediaQuery.of(context).size.height,
              color: Colors.transparent.withOpacity(0.7),
